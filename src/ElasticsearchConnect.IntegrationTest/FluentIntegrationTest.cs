...
namespace ElasticsearchConnect.IntegrationTest
{
    public class FluentIntegrationTest : ITestDataSetup, ITestProcess, IDisposable
    {
        ...
        public static ITestProcess Create()
        {
            ...
            instance.searchEngine = container.Resolve<ISearchEngine<object>>();
            return instance;
        }
        ...
        {
            this.CustomResult = action.Invoke(searchEngine);
            return this;
        }
    ...
    public interface ITestProcess
    {
        ...
        /// Execute search
        /// </summary>
        ITestProcess ExecuteSearch(Model.SearchQueryItem query);
